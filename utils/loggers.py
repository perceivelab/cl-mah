...
class CsvLogger:
    ...
    def write(self, args: Dict[str, Any]) -> None:
        ...
        create_if_not_exists(base_path() + "results/" + args['experiment_name'] + "/" + self.setting)
        create_if_not_exists(base_path() + "results/" + args['experiment_name'] + "/" + self.setting + "/" + self.dataset)
        create_if_not_exists(base_path() + "results/" + args['experiment_name'] + "/" + self.setting + "/" + self.dataset + "/" + self.model)

        write_headers = False
        path = base_path() + "results/" + args['experiment_name'] + "/" + self.setting + "/" + self.dataset + "/" + self.model + "/mean_accs.csv"
        ...
        if self.setting == 'class-il':
            create_if_not_exists(base_path() + "results/" + args['experiment_name'] + "/" + "task-il/" + self.dataset)
            create_if_not_exists(base_path() + "results/" + args['experiment_name'] + "/" + "task-il/" + self.dataset + "/" + self.model)
            ...
            write_headers = False
            path = base_path() + "results/" + args['experiment_name'] + "/" + "task-il" + "/" + self.dataset + "/" + self.model + "/mean_accs.csv"
